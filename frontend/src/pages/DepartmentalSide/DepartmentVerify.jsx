...
const DepartmentVerify = ({ setIsLoggedIn }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    setIsVerifying(true);
    try {
      const res = await axiosInstance.post(`/api/departments/verify-email`, formData);
  ...
  const handleResendCode = async () => {
    ...
    try {
      const res = await axiosInstance.post(`/api/departments/resend-verification`, { email: formData.email });
